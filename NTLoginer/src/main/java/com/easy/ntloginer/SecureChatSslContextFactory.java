...
//    private static String CLIENT_TRUST_KEY_STORE_PASSWORD = "123456";
    ...
    private static String SERVER_KEY_STORE = "d:\\ssl\\sslserverkeys";
    private static String SERVER_TRUST_KEY_STORE = "d:\\ssl\\sslservertrust";
    private static String SERVER_KEY_STORE_PASSWORD = "server";
    private static String SERVER_TRUST_KEY_STORE_PASSWORD = "server";
